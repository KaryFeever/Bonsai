...
import 'package:bonsai/views/creation_page/group_creation_page.dart';
import 'package:bonsai/views/group_page/group_page.dart';
              ...
              title: Row(
                ...
                children: [
                  Column(
                    ...
                    children: [
                      Text(
                        get<HomeController>().plantsShown()
                            ? "Your plants"
                            : "Your groups",
        ...
        body: Stack(
          children: [
              ...
              child: Row(
                ...
                children: [
                  GestureDetector(
                    onTap: () {
                      get<HomeController>().plantsShown()
                          ? {} // make unclickable when plants are shown
                          : get<HomeController>().switchView();
                    },
                    child: Container(
                      height: 50,
                      width: 100,
                      decoration: BoxDecoration(
                          ...
                          color: get<HomeController>().plantsShown()
                              ? Styles.chosenOption
                              : Styles.cupertinoSwitchBlock),
                      child: Row(
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: [
                          Text("Plants",
                              style: get<HomeController>().plantsShown()
                                  ? Styles.settingsHeader
                                  : Styles.settingsHeaderPale),
                        ],
                      ),
                    ),
                  ),
            ...
            Padding(
              ...
              child: Center(
                  child: get<HomeController>().plantsShown()
                      ? ListView.builder(
                          ...
                          itemBuilder: (BuildContext context, int index) {
                            return Padding(
                                ...
                                child: get<HomeController>()
                                        .careTodayPlantNeeded(HomeController()
                                                              ...
                                                              MaterialPageRoute(
                                                                  builder:
                                                                      (context) =>
                                                                          GroupPage(
                                                                            group:
                                                                                get<Groups>().getGroups()[index],
                                                                          ))),
                                                      // Name of the group with auto size.
                                                      child: SizedBox(
                                                        width: 201,
                                                        child: AutoSizeText(
                                                          get<Groups>()
